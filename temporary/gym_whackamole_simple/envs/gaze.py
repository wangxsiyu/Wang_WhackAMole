...
class Gaze(spaces.Box):
    ...
    def set_task_parameters(self, params = None):
        if params is None:
            ...
            params['_vphi_MAX'] = math.pi/4
            params['punish_action_step'] = 0
            params['punish_action_dir'] = 0
            params['punish_de_step_at_0'] = 0
            params['punish_de_phi_at_0'] = 0
            params['punish_ac_step_at_MAX'] = 0
            params['punish_ac_phi_at_MAX'] = 0
    ...
    def step(self, action_dir):
        r1 = 0 # self.accelerate_step(action_step)
